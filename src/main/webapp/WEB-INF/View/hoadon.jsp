        ...
        <div class="table-wrapper">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach var="hoadon" items="${hoadon}">
                	<tr>
                        <td  class="name" data-value =  "ccccccc">${hoadon.getTenkhachhang()}</td>
                        <td  class="name" data-value =  "ccccccc">${hoadon.getSodt()}</td>
                         <td  class="name" data-value =  "ccccccc">${hoadon.getDiachigiaohang()}</td>
                          <td  class="name" data-value =  "ccccccc">${hoadon.getGhichu()}</td>
                           <td  class="name" data-value =  "ccccccc">
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href='<c:url value="/dashboard"/>'><i class="fa fa-cube nav_icon" aria-hidden="true"></i><span>Home</span><div class="clearfix"></div></a></li>
										
										
										 <li id="menu-academico" ><a href='<c:url value="/dashboard/themsanpham"/>'><i class="fa fa-cube nav_icon" aria-hidden="true"></i><span>Sản phẩm</span><div class="clearfix"></div></a></li>
									...
									<li id="menu-academico" ><a href='<c:url value="/dashboard/hoadon"/>'><i class="fa fa-cube nav_icon" aria-hidden="true"></i><span>Hóa đơn</span><div class="clearfix"></div></a></li>
